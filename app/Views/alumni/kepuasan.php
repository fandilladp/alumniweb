                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Kepuasan Lulusan</h3></div>
                                <div class="card-body">
                                <?php if ($errors != null) : ?>
                                ...
                                <div class="form-group">
                                    <?= form_label("Seberapa tinggi kepuasan saudara terhadap berbagai layanan yang diberikan Program Study kepada saudara saat masih kuliah ?", "kepuasanprodi") ?>
                                    <?= form_input($kepuasanprodi) ?>
                                </div>
                                <div class="form-group">
