...
<?= $this->renderSection('isicontent'); ?>
    ...
    <!-- ALL PLUGINS -->
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/jquery.magnific-popup.min.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/jquery.pogo-slider.min.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/slider-index.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/smoothscroll.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/form-validator.min.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/contact-form-script.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/isotope.min.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/<?= base_url('assets') ;?>/perfect-learn/images-loded.min.js"></script>
    <script src="<?= base_url('assets') ;?>/perfect-learn/js/custom.js"></script>
	<script>
	/* counter js */
